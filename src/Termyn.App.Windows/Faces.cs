...
/// then abandoned to the finaliser, on whichever thread happens to be drawing, while the other half
/// is asking GDI+ for the same family. Held here instead, so the face is resolved once and both
/// halves draw code in the same one.
/// </remarks>
