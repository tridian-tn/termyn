...
/// </summary>
public class CommentSubjectTests
{
    ...
    {
        var subject = CommentSubject.Of(Task("t1", "Book the van"), Node(SidebarKind.Project, "p1", "Moving"));
    ...
    public void The_project_you_are_in_is_what_they_are_of_until_you_do()
    {
        ...
        var subject = CommentSubject.Of(null, Node(SidebarKind.Project, "p1", "Moving"));
    ...
    public void Only_a_project_stands_in_for_a_task(SidebarKind kind)
    {
        ...
        var subject = CommentSubject.Of(null, Node(kind, "x1", "Somewhere"));
    ...
    {
        Assert.Equal(CommentSubject.None, CommentSubject.Of(null, null));
    }
    ...
    public void A_task_stands_on_its_own_without_a_sidebar_row_behind_it()
    {
        ...
        var subject = CommentSubject.Of(Task("t2", "Ring the bank"), null);
